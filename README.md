...
## La Solución
Chambea es una plataforma móvil que fusiona lo mejor de LinkedIn y Uber para el mercado de trabajo informal en México. Permite a trabajadores crear un perfil digital verificado con su historial de trabajos, calificaciones y habilidades — y a empleadores publicar trabajos y encontrar candidatos confiables en su zona.
Los pagos se realizan directamente desde la app a través de integraciones con fintechs mexicanas (SPEI, Mercado Pago, OXXO Pay), eliminando el efectivo y dando a los trabajadores un historial financiero formal por primera vez. Los trabajadores operan como contratistas independientes — el mismo modelo legal que usan Uber y Rappi en México — lo que permite flexibilidad sin generar una relación laboral directa con la plataforma.
