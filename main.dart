...
class JobFeedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: _bg,
      appBar: _AppBar('Chambas', actions: [
        IconButton(
          ...
          SliverToBoxAdapter(
            child: SizedBox(
              ...
              child: ListView(
                ...
                children: ['Todos', 'Hogar', 'Construcción', 'Exterior', 'Cuidados', 'Otro']
                    .asMap()
                    .entries
                    .map((e) => Padding(
      ...
      builder: (_, ctrl) => Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _detailRow(Icons.attach_money, 'Pago', job['price']! as String,
                color: _accent),
            ...
            const SizedBox(height: 8),
            const Text(
              'Se requiere persona de confianza para realizar la tarea. Se paga al finalizar el trabajo directamente por la app. El pago está garantizado por Chamba.',
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Aplicar a esta chamba',
                    style:
